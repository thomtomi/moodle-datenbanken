#!/usr/bin/env python3
"""Prüft und baut das moderierte Zusatzmaterial-Preset reproduzierbar."""
...
SOURCE = ROOT / "preset"
RAW_PRESET = ROOT.parents[1] / "02-rohdaten" / "Zusatzmaterial-preset-20260910_0841.zip"
OUTPUT = ROOT / "ausgabe" / "zusatzmaterial-preset.zip"
FILES = (
...
def verify() -> dict[str, object]:
    ...
    required_settings = {"approval": "1", "comments": "0", "rssarticles": "0"}
    ...
    if not all(selector in css for selector in (".zm-db", ".zm-card", ".zm-search")):
