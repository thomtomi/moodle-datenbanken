...
Ein Datenbankeintrag enthält einen vollständigen Sitzplan: **drei Querreihen mit je sieben Tischen**, Name und optionales Foto pro Platz. Wandtafel und mittiges Lehrer:innen-Pult liegen im Plan unten. Reihe 1 ist dem Pult am nächsten, Platz 1 liegt links aus Sicht der Lehrperson. Die Anordnung entspricht der als Ausgangspunkt verwendeten Interpretation des Auftrags.
...
2. `ausgabe/sitzplan-preset.zip` importieren und die 44 Felder kontrollieren: Plan, Raum sowie 21 Name-/Foto-Paare. Die technische Referenz ist Moodle 5.1.0; Version und Theme Ihrer Zielinstanz sind noch offen.
...
5. Einen Eintrag erstellen, zum Beispiel «Klasse BMS · September», und den Raum ergänzen. Pro Tisch den Namen eintragen. Unbesetzte Plätze bleiben leer. Über «Foto · optional» kann je Tisch ein Porträt mit Alternativtext hochgeladen werden.
...
- Einzelansicht: vollständiger Sitzplan mit Namen und vorhandenen Fotos. Die Raumaufteilung bleibt auf dem Handy erhalten; der Plan ist mit Tastatur oder Berührung seitlich scrollbar.
- Listenansicht: nur Planname, Raum und «Sitzplan öffnen».
- Eingabe: drei Abschnitte mit je sieben nummerierten Plätzen. Fotos lassen sich bei Bedarf aufklappen.
...
Die erste Version hat fest 21 Plätze. Weitere Raumgrössen erfordern eine abgestimmte Änderung der Felder und Vorlagen; die Zeilenanzahl im Build nicht nach einem produktiven Import unkontrolliert ändern.
